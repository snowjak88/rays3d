...
public abstract class Shape implements Transformable, DescribesSurface {
	...
	/**
	 * Given a point (expressed in global coordinates) which this shape is
	 * viewed from, compute the solid angle which this shape subtends as seen
	 * from that Point -- <em>assuming</em> that this shape looks like a sphere.
	 * 
	 * @param viewedFrom
	 * @param sphereRadius
	 * @return
